...
NUMERIC_FIELD_SPECS = {
    ...
    "slots": {"label": "槽数", "kind": "int", "min": 1, "unit": "个", "suggestion": "请输入正整数槽数，例如 24。"},
    ...
    "p": {"label": "极对数", "kind": "int", "min": 1, "unit": "对", "suggestion": "请输入正整数极对数，例如 8。"},
    ...
    "N_ph_turns": {"label": "每相匝数", "kind": "int", "min": 1, "unit": "匝", "suggestion": "请输入正整数匝数，例如 50。"},
    "d_wire": {"label": "导线直径", "kind": "float", "min": 0.0, "unit": "mm", "suggestion": "请输入大于 0 的导线直径，例如 0.9。"},
    "n_parallel": {"label": "并联支路数", "kind": "int", "min": 1, "unit": "路", "suggestion": "请输入正整数并联支路数，例如 2。"},
